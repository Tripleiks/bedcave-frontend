          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <div className="p-6 relative">
                ...
                <a href="https://ui.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-[#00d4ff] font-mono text-sm hover:underline">
                  <span>ui.com</span>
            ...
            >
              ...
              <div className="p-6 relative">
                ...
                <a href="https://unraid.net" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-[#ff6c00] font-mono text-sm hover:underline">
            ...
            >
              ...
              <div className="p-6 relative">
                ...
                <a href="https://omarchy.org/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-[#8338ec] font-mono text-sm hover:underline">
